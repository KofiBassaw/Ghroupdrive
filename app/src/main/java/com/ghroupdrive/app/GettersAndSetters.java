...
public class GettersAndSetters {
    ...
    public String getDriversProfileUrl() {
        return driversProfileUrl;
    }

    public void setDriversProfileUrl(String driversProfileUrl) {
        this.driversProfileUrl = driversProfileUrl;
    }
